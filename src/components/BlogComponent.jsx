...
<<<<<<< HEAD
        <span className="absolute bottom-0 right-0 bg-[#C3A666] text-white text-sm font-semibold px-4 py-2">{post.date}</span>
      </div>
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-xl font-bold text-gray-800 mb-3 hover:text-[#C3A666] transition-colors">
          <a href={post.link}>{post.title}</a>
        </h3>
        <div className="flex items-center text-sm text-g[#C3A666] mb-4">
          <div className="flex items-center"><FaUser className="mr-2 text-[#C3A666]" /><span>{post.author}</span></div>
          <span className="mx-3">/</span>
          <div className="flex items-center"><FaFolderOpen className="mr-2 text-[#C3A666]" /><span>{post.category}</span></div>
        </div>
        <p className="text-gray-600 mb-4 flex-grow">{post.excerpt}</p>
        <hr className="my-4"/>
        <a href={post.link} className="font-bold text-[#C3A666] hover:text-gray-600 flex items-center self-start">
=======
        <span className="absolute bottom-0 right-0 bg-[#FFD700] text-white text-sm font-semibold px-4 py-2">{post.date}</span>
      </div>
      <div className="p-6 flex flex-col flex-grow">
        <h3 className="text-xl font-bold text-gray-800 mb-3 hover:text-[#FFD700] transition-colors">
          <a href={post.link}>{post.title}</a>
        </h3>
        <div className="flex items-center text-sm text-g[#FFD700] mb-4">
          <div className="flex items-center"><FaUser className="mr-2 text-[#FFD700]" /><span>{post.author}</span></div>
          <span className="mx-3">/</span>
          <div className="flex items-center"><FaFolderOpen className="mr-2 text-[#FFD700]" /><span>{post.category}</span></div>
        </div>
        <p className="text-gray-600 mb-4 flex-grow">{post.excerpt}</p>
        <hr className="my-4"/>
        <a href={post.link} className="font-bold text-[#FFD700] hover:text-gray-600 flex items-center self-start">
