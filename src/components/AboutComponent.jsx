            ...
            <div className="relative lg:ml-auto lg:w-1/2 lg:pl-12">
              ...
              >
                ...
                <div className="our-story">
                  <h3 className="text-[#feb900] font-bold text-2xl mb-3">{t('pages.about.story.subtitle')}</h3>
                  <p className="text-gray-600 mb-4">{t('pages.about.story.paragraph')}</p>
                  <ul className="space-y-2 mb-6">
                    {storyListItems.map((item, index) => (
                      <li key={index} className="flex items-start"><BsCheckCircle className="text-[#feb900] mr-3 mt-1 flex-shrink-0" /><span>{item}</span></li>
                    ))}
                  </ul>
                  {/*  */}
                </div>
